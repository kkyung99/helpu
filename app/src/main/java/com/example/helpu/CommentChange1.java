...
public class CommentChange1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_commentchange1);
        ...
        btn_change.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                db.collection("communityAComments").document(intent.getStringExtra("id")).set(post).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
